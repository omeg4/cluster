...
(*
I want to:
 -- Check that eigenfunctions are orthonormalized
 -- Calculate f0 (will also automatically yield forbidden/allowed transitions)
 -- Display eigenenergies and transition energies
*)
